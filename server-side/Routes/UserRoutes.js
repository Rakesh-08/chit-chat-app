let {addNewContact,getAllContact,updateUser,uploadProfileImage,getUserById }= require("../controllers/userController")
...
module.exports = (app) => {
    ...
    app.get("/chat-app/user/:userId",verifyToken,getUserById)
}